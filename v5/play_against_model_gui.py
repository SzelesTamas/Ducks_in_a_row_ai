...
class Game:
    """This is a class for managing the Deep Q agent and creating a GUI."""

    def __init__(
        self,
        screen,
        agentInd: int = 2,
        networkPath: str = None,
    ):
        ...
        Args:
            ...
            networkPath (str): The path to the neural network that the agent uses.
        """
        ...
        self.agent = QAgent(QNetwork(networkPath))
        self.onTurn = 1
    ...
    def agentTurn(self):
        ...
        moveInd = self.agent.getMove(self.currentState, self.agentInd)
...
if __name__ == "__main__":
    ...
    modelPath = "models/v2"
    networkPath = os.path.join(modelPath, "network.pt")
    game = Game(
        screen=screen,
        agentInd=1,
